...
public class Respuesta extends javax.swing.JFrame {
    ...
    /**
     * Método para establecer el nombre en el saludo
     */
    public void setNombre(String nombre) {
        if (nombre == null || nombre.trim().isEmpty()) {
            jLabel1.setText("¡Hola, persona sin nombre!");
        } else {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // Cerrar la ventana de respuesta y mostrar de nuevo la ventana principal
        this.dispose();
